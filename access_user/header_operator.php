...
<div class="content">
 ...
 <ul class="top-level" >
        <li><a href="#">Operator Duties</a>
            <ul class="sub-level">
                <li><a href="validate_requests.php">Asssign Seats</a></li>
                <li><a href="make_ticket_slip.php">Generate Slips</a></li>
                <li><a href="register_reservations.php">Register Reservations</a></li>
                <li><a href="register_cargo.php">register Cargo </a></li>
            </ul>
        </li>
        ...
        <li><a href="contact_us.php">Contact</a></li>
         <li>
            ...
            <ul class="sub-level">
                ...
                <li><a href="operatorop/check_duty_timing.php">Duty Timing</a></li>
