...
<div class="form-group">Use this form to change the access level or replace the user's email and/or password.</p>
  <label for="login">User name :</label>
  <b><?php echo $admin_update->user_name; ?></b></div>
  ...
  <input name="send_confirmation" type="checkbox" value="yes">
</div>
<div class="form-group">
  ...
  <input class="form-controls" type="submit" name="Submit" value="Update">
  <div class="form-group">
...
<div class="form-container">
	<div class="form-group">
<?php   $query1= mysql_select_db("busticket");
        $query2= mysql_connect("localhost", "root", "toor"); 
        $result=mysql_query("SELECT * From Users") or die (mysql_error());
      if (mysql_num_rows($result) > 0) {
    // output data of each row
    while($row = mysql_fetch_assoc($result)) {
        echo "id: " . $row["login"]. " - Name: " . $row["real_name"]. "Access-Level: " . $row["access_level"]. "<br>";
    }
} else {
    echo "0 results";
}
