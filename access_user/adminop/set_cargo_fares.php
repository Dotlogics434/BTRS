                    ...
                    <div class="col-sm-7">
                        ...
                        <div class=""><!--Reservation Piece of Code-->
                            ...
                            <div class="panel panel-ybtm-red">
                                    ...
                                    <h3 class="panel-title">Set Cargo Fares</h3>
                                    
                                    </div>
                               
                                
                                <div class="panel-body" style="margin-top:30px">
                                    <form class= "Ticket-Fare-lookup" id="TicketFares" role="form" action="set_cargo_fare.php" method="post" >
                                 <div class="form-controls">
                                     <div class="form-controls">
                                        <label class="form-controls" for="busid" style="margin-left:20px">BUS ID</label>
                                        <input class="form-controls" name="busid" type="text" size="10" placeholder="Bus Id ####">
                                      </div>
                                    <label class="form-controls" for="source" style="margin-left:20px">From</label>
                                     ...
                                     <select class="form-controls" name="destination" style="margin-left:px">
                                        ...
                                        <div class="form-controls">
                                        <label class="form-controls" for="cargoFare" style="margin-left:20px">Rate</label>
                                        <input class="form-controls" name="cargoFare" type="text" size="10" placeholder="rate">
