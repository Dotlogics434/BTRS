                                ...
                                <div class="panel-body" style="margin-top:30px">
                                 ...
                                 <div class="form-controls">
                                    <label class="form-controls" for="busid" style="margin-left:20px">Bus Id</label>
                                        <input class="form-controls" type="text" size="10" name="busid" placeholder="BUS Id ####">
                                    <label class="form-controls" for="source" style="margin-left:20px">From</label>
                                     ...
                                     <select class="form-controls" name="destination" style="margin-left:px">
                                        ...
                                        <label class="form-controls" for="ticketFare" style="margin-left:20px">Ticket Fare</label>
                                        <input class="form-controls" name="ticketFare" type="text" size="10" placeholder="rate">
                                       <label class="form-controls" for="source" style="margin-left:20px">Date & Time</label>
