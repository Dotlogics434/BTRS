...
<?php   
                ...
                //$dateTime=$_POST['time'];
                $cargoFare=$_POST['cargoFare'];
                error_reporting(E_ERROR | E_PARSE);
                $query = mysql_query("UPDATE cargofares SET   source='".$source."',  destination='".$destination."', cargoFare='".$cargoFare."'
                WHERE busid='".$busid."' ") or die (mysql_error());
                if($query){
